...
public final class GeoHash implements Comparable<GeoHash>, Serializable {
	...
	/**
	 * returns the {@link GeoPoint} that was originally used to set up this.<br>
	 * If it was built from a base32-{@link String}, this is the center point of
	 * the bounding box.
	 */
	public GeoPoint getOriginatingPoint() {
		return point;
	}
	...
	public boolean enclosesCircleAroundPoint(GeoPoint point, double radius) {
		return false;
	}
