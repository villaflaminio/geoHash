...
public class VincentyGeodesy {
	...
	/**
	 * returns the {@link GeoPoint} that is in the given direction at the
	 ...
	 */
	public static GeoPoint moveInDirection(GeoPoint point, double bearingInDegrees, double distanceInMeters) {
